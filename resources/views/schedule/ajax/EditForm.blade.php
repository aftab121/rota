{!! Form::open(array('url' => '#','id'=>'editPositionForm','class'=>'form-horizontal m-t-20')) !!} 
	<ul class="nav nav-tabs">
	  <li class="active"> <a href="#editl1" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="fa fa-cube" aria-hidden="true"></i></span> <span class="hidden-xs"><i class="fa fa-cube" aria-hidden="true"></i> Position Details</span> </a> </li>
	  ...
	  <li class=""> <a href="#editl3" data-toggle="tab" aria-expanded="false"> <i class="fa fa-users" aria-hidden="true"></i> <span class="visible-xs"><i class="fa fa-users" aria-hidden="true"></i></span> <span class="hidden-xs">Employees at <?php echo @$Position['position_name']; ?></span> </a> </li>
	</ul>
