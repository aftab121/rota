         ...
         <div class="col-lg-9 col-md-9"><button type="button" class="btn pull-right btn-purple waves-effect waves-light" id="add_new"> <i class="fa fa-plus"></i> Add New</button></div>
          <div class="col-lg-9 col-md-9 content-height" id="add_user" >
            ...
            <ul class="nav nav-tabs">
              ...
              <li class=""> <a href="#addl3" data-toggle="tab" aria-expanded="false"> <i class="fa fa-star" aria-hidden="true"></i> <span class="visible-xs"><i class="fa fa-star" aria-hidden="true"></i></span> <span class="hidden-xs"> Positions</span> </a> </li>
              <li class=""> <a href="#addl4" data-toggle="tab" aria-expanded="false"> <i class="fa fa-usd" aria-hidden="true"></i> <span class="visible-xs"><i class="fa fa-usd" aria-hidden="true"></i></span> <span class="hidden-xs"> Salary / Wage</span> </a> </li>
              <li style="float:right;"> <div class="col-md-12">
                ...
                <div class="row m-t-20">
                  <div class="col-lg-12">
                    <ul class="nav nav-tabs ">
                      ...
                      <li class="tab"> <a href="#month_pane" data-toggle="tab" aria-expanded="false"> <span class="visible-xs "><i class="fa fa-user"></i></span> <span class="hidden-xs ">Monthly Salary </span> </a> </li>
                    ...
                    <div class="tab-content" style="padding: 30px 15px;">
                      <div class="tab-pane active custom-tab-style" id="home-21">
                        <p><span><strong>Standard Rate:</strong> </span>$
					  ...
					  <div class="tab-pane  custom-tab-style" id="month_pane">
                        <p><strong>Monthly Rate:</strong> $
                          <button type="button" class="editable editable-click addButton" >Set Rate</button>
                          <span class='TextBoxesGroup' style="display:none;"> {!! Form::text('monthly_rate',@$inputData['monthly_rate'],array('class'=>'form-control-custom','placeholder'=>'Monthly Rate/per annum','onkeypress'=>'return isNumber(event)')) !!} </span> <span class="removeButton" style="display:none">
                          <input type='button' value='Remove' class="btn btn-danger " style="padding: 4px 12px;">
                          </span> </p>
                      </div> 
