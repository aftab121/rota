...
<div class="content-page">
					   ...
					   <div class="tab-pane active" id="home">
						...
						{!! Form::open(array('url' => '#','id'=>'Companyform','class'=>'form-horizontal m-t-20')) !!}          
						  ...
						  <div class="card-box clearfix">
								  ...
								  <h4 class="d-inline">Company Target</h4>
								   ...
								   <div class="card-body" id="target_div" >
									 <div class="col-md-6">
										...
										<div class="col-md-6">Company Targeting Based on Yearly Performance</div>
										 <div class="col-md-6">
										  <input type="checkbox" class="compny_target" name="yearly_company_target" <?php echo (@$CompanyDetails['yearly_company_target']=='1')?'checked':'';?>  data-target="yearly_company_target" data-toggle="toggle" data-on="on" data-off="off" data-onstyle="success" data-offstyle="danger"> </div>
									 </div>
									<div class="yearly_company_target" style="display:block">
									 <div class="form-group">
									<label class="col-md-3 control-label" for="example-email">Last Year Target Achieved</label>
									<div class="col-md-9">
									  {!! Form::number('last_year_target',@$CompanyDetails['last_year_target'],array( 'step'=>"any",'class'=>'form-control','placeholder'=>'Last Year Target Achieved')) !!}
									</div>
								</div>
									<div class="form-group">
										<label class="col-md-3 control-label" for="example-email">Percentage Growth(this Year)</label>
										<div class="col-md-9">
										  {!! Form::number('percentage_growth',@$CompanyDetails['percentage_growth'],array('step'=>"any",'class'=>'form-control','placeholder'=>'Percentage Growth(this Year)')) !!}
										</div>
</div>
									<div class="form-group" >
									<label class="col-md-3 control-label">Percentage Growth(By Store)</label>
									<div class="col-md-9">
									 <?php if($Locationlist): ?>
									 <?php foreach($Locationlist as $Location): ?><div class="row">
										<div class="col-md-6"><?php echo $Location['location_name']; ?></div>
										<div class="col-md-6"> {!! Form::number('location_percentage_'.$Location['location_id'],@$Location['location_target_percentage'],array('step'=>'any','class'=>'form-control','placeholder'=>'Percentage Growth(By Location)')) !!}</div>
										</div>
										<?php endforeach;
										endif;?>
									</div>
									<div class="col-md-9" style="float:left;"> <strong> Total Sum of Percentage to be 100 % </strong> </div>
								</div>
										 </div>
									  <div class="row m-b-15">
										<div class="col-md-6">Store Targeting Based on Yearly Performance</div>
										 <div class="col-md-6">
										  <input type="checkbox" class="compny_target" name="yearly_store_target" <?php echo (@$CompanyDetails['yearly_store_target']=='1')?'checked':'';?>  data-target="yearly_store_target" data-toggle="toggle" data-on="on" data-off="off" data-onstyle="success" data-offstyle="danger"> </div>
									 </div>
									   <div class="yearly_store_target" style="display:none">
									 <div class="form-group">
									<label class="col-md-3 control-label" for="example-email">Last Year Store Target Achieved</label>
									<div class="col-md-9">
									  {!! Form::number('store_last_year_target',@$CompanyDetails['store_last_year_target'],array( 'step'=>"any",'class'=>'form-control','placeholder'=>'Last Year Target Achieved')) !!}
									</div>
								</div>
									<div class="form-group">
										<label class="col-md-3 control-label" for="example-email">Store Percentage Growth(this Year)</label>
										<div class="col-md-9">
										  {!! Form::number('store_percentage_growth',@$CompanyDetails['store_percentage_growth'],array('step'=>"any",'class'=>'form-control','placeholder'=>'Percentage Growth(this Year)')) !!}
										</div>
</div>
										 </div>
									   ...
									   <div class="row m-b-15">
										<div class="col-md-6">Company Targeting Based on Monthly Performance</div>
										 <div class="col-md-6">
										  <input type="checkbox" class="compny_target" name="monthly_company_target" <?php echo (@$CompanyDetails['monthly_company_target']=='1')?'checked':'';?> data-target="monthly_company_target" data-toggle="toggle" data-on="on" data-off="off" data-onstyle="success" data-offstyle="danger"> </div>
									 </div>
										<div class="row m-b-15">
										<div class="col-md-6">Store Targeting Based on Monthly Performance</div>
										 <div class="col-md-6">
										  <input type="checkbox" class="compny_target" name="monthly_store_target" <?php echo (@$CompanyDetails['monthly_store_target']=='1')?'checked':'';?> data-target="monthly_store_target" data-toggle="toggle" data-on="on" data-off="off" data-onstyle="success" data-offstyle="danger"> </div>
									 </div>
									 </div>
                            ...
                            <div class="card-gray">
                             <div class="card-header"><h4 class="d-inline">Budgeting</h4></div>
                                <div class="row">
                                <div class="col-md-12">
  ...
  <tr>
    <td>
    <div class="heading">jan</div>
    <div class="form-group">
    <label class="col-md-8">Last Year Target Achieved</label><div class="col-md-4"><input type="text" /></div>
     </div>
     <div class="form-group">
   <label class="col-md-8">Percentage Growth(this Year)</label><div class="col-md-4"><input type="text" /></div>
     </div>
     <div class="form-group">
   <div  class="col-md-12">
   <div class="row">
  <div class="col-md-6"><label>Percentage Growth(By Store)</label></div>
   <div class="col-md-6">
   <div class="row">
     <label class="col-md-6">location1</label>
   ...
   <div  class="col-md-8">
   <div class="row">
   <label class="col-md-6">Percentage Growth(By Store)</label><label class="col-md-6">location1</label>
   </div></div><div class="col-md-4"><input type="text" /></div>
     </div>
    </td>
    <td>
     <div class="heading">mar</div>
    <div class="form-group">
    <label class="col-md-8">Last Year Target Achieved</label><div class="col-md-4"><input type="text" /></div>
     </div>
     <div class="form-group">
								  ...
								  <h4 class="d-inline">Budgeting</h4>
								   ...
								   <div class="card-body" id="budget_div"  style="display:<?php echo (@$CompanyDetails['budget']=='1')?'block':'none';?>;">
									 ...
									 <div class="col-md-6">
									  ...
									  <div class="row m-b-15">
										<div class="col-md-6">Labour Hours</div>
										 <div class="col-md-6">
									   ...
									   <div class="row m-b-15">
										<div class="col-md-6">Labour Adjustment</div>
										 <div class="col-md-6">
										...
										<div class="row m-b-15">
										<div class="col-md-6">Sales Per Hour</div>
										 <div class="col-md-6">
    ...
    <div class="col-md-12">
		...
		<div class="card-box clearfix" id="AddReminderForm" style="display:none;">
			...
			<div class="col-md-7 col-md-offset-2">
					...
					{!! Form::open(array('url' => '#','id'=>'AddReminder','class'=>'form-horizontal m-t-20')) !!} 
					<div class="form-group clearfix">
...
$(document).ready(function(){
	...
	$('body .compny_target').change(function(){
		...
		}elseif(target=='yearly_store_target'){
