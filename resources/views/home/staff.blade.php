  ...
  <div class="content-page"> 
    ...
    <div class="content">
      <div class="container"> 
        ...
        <div class="row">
          <div class="col-md-3 col-sm-3 col-xs-4 res-4">
              ...
              <div class="store-list staff-all">
                <form  id="liclickForm">
                  ...
                  <ul id="userlists">
                    ...
                    <li data-id ="{{ $user['id']}}" class="liclick liclick_<?php echo $user['id'];?> checked"><span><img src="{{ asset('images/'.$img) }}" ></span><?php echo $user['firstname']." ".$user['lastname'];?> </li>
                    <?php endforeach;
					 endif;?>
                  </ul>
                </form>
          ...
          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-8 res-8">
            <button type="button" class="btn pull-right btn-purple waves-effect waves-light" id="add_new"> <i class="fa fa-plus"></i> Add New</button>
          </div>
          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-8 res-8 content-height" id="add_user" >
            ...
            <div class="tab-content clearfix">
                ...
                <div class="staff-profile">
                  ...
                  <div class="col-md-8 col-sm-8">
                    <div class="profile-form">
                      <h4  class="header-title m-t-0 m-b-20 col-md-12 res-padding"><strong>Personal Information</strong></h4>
                      <div  class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="input-group"> {!! Form::text('start_date_with_company',@$inputData['start_date_with_company'],array('class'=>'form-control','id'=>'datepicker-inline1','placeholder'=>'Joining Date')) !!} <span class="input-group-addon bg-custom b-0 text-white"><i class="icon-calender"></i></span> </div>
                        </div>
                      </div>
                      <div  class="col-md-6">
                        <div class="form-group">
                  ...
                  <div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        {!! Form::textarea('notes',@$inputData['notes'],array('class'=>'form-control','rows' =>4,'placeholder'=>'Additional Notes')) !!} </div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="rate">
                <div class="row m-t-20">
                  <div class="col-lg-12 res-padding">
                    <ul class="nav nav-tabs ">
                      <li class="active tab"> <a href="#home-21" data-toggle="tab" aria-expanded="false"> <i class="fa fa-home"></i>Hourly Wage  </a> </li>
                      <li class="tab"> <a href="#profile-21" data-toggle="tab" aria-expanded="false"> <i class="fa fa-user"></i>Yearly Salary  </a> </li>
                    </ul>
                    <div class="tab-content contnt-tab">
        ...
        {!! Form::close() !!} </div>
      <div class="col-lg-9 col-sm-8 res-8 col-xs-8 content-height"  id="edit_staff" > </div>
    </div>
  </div>
  <!-- container --> 
